      ...
      <div className="home-layout">
        ...
        <section className="home-hero">
          ...
          <p className="home-hero__sub">
            Import from PDF or plain text, review and edit the metadata, and
            look up any abbreviation in the dictionary.
          </p>
        ...
        <aside className="home-tiles">
          <Link to="/import/pdf" className="home-tile">
            ...
            <div className="home-tile__body">
              ...
              <span className="home-tile__desc">
                Drop a PDF and we'll extract gauge, yarn and sizes
                automatically.
              </span>
            </div>
          ...
          <Link to="/import/text" className="home-tile">
            ...
            <div className="home-tile__body">
              ...
              <span className="home-tile__desc">
                Copy-paste any plain-text pattern and we'll parse the structure.
              </span>
            </div>
            <span className="home-tile__arrow">→</span>
          </Link>
          ...
          <Link to="/dictionary" className="home-tile">
            ...
            <div className="home-tile__body">
              ...
              <span className="home-tile__desc">
                Look up knitting and crochet abbreviations with video guides.
              </span>
            </div>
            <span className="home-tile__arrow">→</span>
          </Link>
